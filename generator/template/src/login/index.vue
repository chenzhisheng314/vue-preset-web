      ...
      <div class="right">
        <div class="login-container">
          <div class="login-content">
            <div class="login-header" v-for="(item, index) in loginHeader" :key="index">
              <ul class="clear-both" v-if="setLoginHeader(index)">
            ...
            <!-- 密码登录 -->
            <div class="login-item" v-show="loginActive === '1'">
              <el-form :model="ruleForm" :rules="rules" ref="emailForm" class="login-form">
                <el-form-item
